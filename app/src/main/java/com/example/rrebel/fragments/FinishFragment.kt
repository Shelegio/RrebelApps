package com.example.rrebel.fragments
...
class FinishFragment: Fragment(R.layout.fragment_finish) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            alertDialogBuilder.setTitle("პანდა მადლობას გიხდით <333")
            alertDialogBuilder.setMessage("დიახ, როგორც მიხვდით, ნამდვილად ერთ-ერთი ყველაზე ზარმაცი ცხოველი ვარ მსოფლიოში! ")
